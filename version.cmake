...
if(AU_TRIEFLOW_DISTRIBUTION)
    set(MUSE_APP_NAME_HUMAN_READABLE "WaveWeft")
    set(MUSE_APP_NAME_MACHINE_READABLE "WaveWeft")
    set(MUSE_APP_NAME_HUMAN_READABLE_COMPAT "WaveWeft")
    set(MUSE_APP_NAME_MACHINE_READABLE_COMPAT "WaveWeft")
    # Keep the existing OS/application identity; customer branding is independent.
    set(MUSE_APP_GUI_IDENTIFIER com.trieflow.WaveQuay)
